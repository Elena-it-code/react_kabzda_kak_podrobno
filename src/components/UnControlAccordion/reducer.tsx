...
export const TOGGLE_COLLAPSED = "TOGGLE-COLLAPSED"     // использование CONSTANt не даст нам ошибиться при написании свойств, опечататься случайно. Далее используем уже эти const
